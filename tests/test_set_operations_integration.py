...
class TestSETWithRETURNIntegration:
    ...
    def test_set_return_modified_properties(
        ...
        RETURN e.name AS name,
               ...
               (e.salary - e.old_salary) AS increase
        """
    ...
    def test_set_return_relationship_updates(
        ...
        RETURN e.name AS employee,
               p.name AS project,
               a.utilization_rate AS utilization
        """
...
class TestSETInMultiStepPipelines:
    ...
    def test_set_multi_step_employee_analysis(
        ...
        RETURN e.name AS name,
               ...
               e.retention_priority AS priority
        """
    ...
    def test_set_cascading_property_updates(
        ...
        RETURN e.name AS name,
               ...
               e.career_fast_track AS fast_track
        """
    ...
    def test_set_performance_normalization_pipeline(
        ...
        RETURN emp.department AS department,
               emp.name AS name,
               emp.normalized_score AS norm_score
        """
...
class TestSETWithComplexExpressions:
    ...
    def test_set_mathematical_calculations(
        ...
        RETURN e.name AS name,
               round(e.value_score, 2) AS value_score
        """
...
class TestSETErrorHandlingAndEdgeCases:
    ...
    def test_set_division_by_zero_protection(
        ...
        SET e.salary_per_experience = CASE
            ...
            END
        RETURN e.name AS name,
               e.salary_per_experience AS salary_ratio
        """
...
class TestSETPerformanceOptimization:
    ...
    def test_set_indexed_property_updates(
        ...
        RETURN e.name AS name,
               e.status_last_checked AS checked
        """
    ...
    def test_set_minimal_property_updates(
        ...
        RETURN count(*) AS flagged_employees
        """
