...
from pycypher.ast_models import ASTConverter, CaseExpression, ListComprehension, Quantifier
...
class TestComplexStructures:
    ...
    def test_quantifier_any_structure(self, parser, converter):
        ...
        assert typed_quantifier.quantifier == "ALL"  # Field is 'quantifier' based on repr
