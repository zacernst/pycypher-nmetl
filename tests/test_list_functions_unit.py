...
class TestHead:
    ...
    def test_empty_list_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
...
class TestSort:
    ...
    def test_sort_null_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
...
class TestFlatten:
    ...
    def test_flatten_null_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
...
class TestToIntegerList:
    def test_strings_to_integers(
        self, registry: ScalarFunctionRegistry
    ) -> None:
        result = registry.execute(
            "toIntegerList", [pd.Series([["1", "2", "3"]])]
        )
        assert result.iloc[0] == [1, 2, 3]

    def test_floats_truncated(self, registry: ScalarFunctionRegistry) -> None:
        result = registry.execute(
            "toIntegerList", [pd.Series([["1.9", "2.1"]])]
        )
        assert result.iloc[0] == [1, 2]

    def test_unconvertible_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
...
class TestToBooleanList:
    def test_string_booleans(self, registry: ScalarFunctionRegistry) -> None:
        result = registry.execute(
            "toBooleanList", [pd.Series([["true", "false"]])]
        )
        assert result.iloc[0] == [True, False]
...
class TestListMin:
    ...
    def test_min_empty_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
        result = registry.execute("min", [pd.Series([[]])])
        assert result.iloc[0] is None

    def test_min_null_input_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
        result = registry.execute("min", [pd.Series([None])])
        assert result.iloc[0] is None

    def test_min_all_nulls_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
...
class TestListMax:
    ...
    def test_max_empty_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
        result = registry.execute("max", [pd.Series([[]])])
        assert result.iloc[0] is None

    def test_max_null_input_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
...
class TestTrigFunctions:
    ...
    def test_atan2(self, registry: ScalarFunctionRegistry) -> None:
        result = registry.execute(
            "atan2", [pd.Series([1.0]), pd.Series([1.0])]
        )
...
class TestLog10:
    ...
    def test_log10_zero_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
        result = registry.execute("log10", [pd.Series([0.0])])
        assert result.iloc[0] is None

    def test_log10_negative_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
        result = registry.execute("log10", [pd.Series([-1.0])])
        assert result.iloc[0] is None

    def test_log10_null_returns_null(
        self, registry: ScalarFunctionRegistry
    ) -> None:
...
class TestPow:
    ...
    def test_pow_null_propagation(
        self, registry: ScalarFunctionRegistry
    ) -> None:
        result = registry.execute("pow", [pd.Series([None]), pd.Series([2.0])])
        assert result.iloc[0] is None

    def test_pow_negative_base_fractional_exp(
        self, registry: ScalarFunctionRegistry
    ) -> None:
