...
class TestNodeStructure:
    ...
    def test_node_with_labels(self, parser):
        ...
        node = ast["statements"][0][0]["clauses"][0]["pattern"]["paths"][0]["element"]["parts"][0]
...
class TestRelationshipStructure:
    ...
    def test_directed_relationship(self, parser):
        ...
        parts = ast["statements"][0][0]["clauses"][0]["pattern"]["paths"][0]["element"]["parts"]
        # parts: [Node, Rel, Node]
        rel = parts[1]
    ...
    def test_undirected_relationship(self, parser):
        ...
        rel = ast["statements"][0][0]["clauses"][0]["pattern"]["paths"][0]["element"]["parts"][1]
...
class TestWhereClauseStructure:
    ...
    def test_arithmetic_expression(self, parser):
        ...
        expr = ast["statements"][0][0]["return"]["body"]["items"][0]["expression"]
