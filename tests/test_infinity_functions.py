...
class TestIsInfinite:
    ...
    def test_positive_infinity(self, reg: ScalarFunctionRegistry) -> None:
        ...
        assert reg.execute("isInfinite", [s]).iloc[0] == True
    ...
    def test_column(self, reg: ScalarFunctionRegistry) -> None:
        ...
        assert result[0] is False or result[0] == False
        assert result[1] is True
        assert result[2] is True
        assert result[3] is False or result[3] == False
...
class TestIsFinite:
    ...
    def test_finite_value(self, reg: ScalarFunctionRegistry) -> None:
        s = pd.Series([42.0])
        assert reg.execute("isFinite", [s]).iloc[0] == True
    ...
    def test_column(self, reg: ScalarFunctionRegistry) -> None:
        ...
        assert result[2] is False or result[2] == False
        assert result[3] is False or result[3] == False
