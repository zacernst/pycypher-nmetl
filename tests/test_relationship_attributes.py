...
def test_context():
    ...
    relationship_table_knows = RelationshipTable(
        ...
        identifier=knows_id,
        column_names=[
            DisambiguatedColumnName(relation_identifier=knows_id, column_name=ID_COLUMN),
            DisambiguatedColumnName(relation_identifier=knows_id, column_name=RELATIONSHIP_SOURCE_COLUMN),
            DisambiguatedColumnName(relation_identifier=knows_id, column_name=RELATIONSHIP_TARGET_COLUMN),
            DisambiguatedColumnName(relation_identifier=knows_id, column_name='since'),
            DisambiguatedColumnName(relation_identifier=knows_id, column_name='strength'),
            DisambiguatedColumnName(relation_identifier=knows_id, column_name='verified'),
        ],
        ...
        attribute_map={
            RELATIONSHIP_SOURCE_COLUMN: DisambiguatedColumnName(relation_identifier=knows_id, column_name=RELATIONSHIP_SOURCE_COLUMN),
            RELATIONSHIP_TARGET_COLUMN: DisambiguatedColumnName(relation_identifier=knows_id, column_name=RELATIONSHIP_TARGET_COLUMN),
            'since': DisambiguatedColumnName(relation_identifier=knows_id, column_name='since'),
            'strength': DisambiguatedColumnName(relation_identifier=knows_id, column_name='strength'),
            'verified': DisambiguatedColumnName(relation_identifier=knows_id, column_name='verified'),
        },
    ...
    relationship_table_lives_in = RelationshipTable(
        ...
        column_names=[
            DisambiguatedColumnName(relation_identifier=lives_in_id, column_name=ID_COLUMN),
            DisambiguatedColumnName(relation_identifier=lives_in_id, column_name=RELATIONSHIP_SOURCE_COLUMN),
            DisambiguatedColumnName(relation_identifier=lives_in_id, column_name=RELATIONSHIP_TARGET_COLUMN),
            DisambiguatedColumnName(relation_identifier=lives_in_id, column_name='since'),
            DisambiguatedColumnName(relation_identifier=lives_in_id, column_name='rent'),
        ],
        source_obj_attribute_map={
            RELATIONSHIP_SOURCE_COLUMN: RELATIONSHIP_SOURCE_COLUMN,
            RELATIONSHIP_TARGET_COLUMN: RELATIONSHIP_TARGET_COLUMN,
        ...
        attribute_map={
            RELATIONSHIP_SOURCE_COLUMN: DisambiguatedColumnName(relation_identifier=lives_in_id, column_name=RELATIONSHIP_SOURCE_COLUMN),
            RELATIONSHIP_TARGET_COLUMN: DisambiguatedColumnName(relation_identifier=lives_in_id, column_name=RELATIONSHIP_TARGET_COLUMN),
            'since': DisambiguatedColumnName(relation_identifier=lives_in_id, column_name='since'),
            'rent': DisambiguatedColumnName(relation_identifier=lives_in_id, column_name='rent'),
        },
    ...
    # Create context
    context = Context(
        entity_mapping=EntityMapping(mapping={"Person": entity_table_person, "City": entity_table_city}),
        relationship_mapping=RelationshipMapping(mapping={"KNOWS": relationship_table_knows, "LIVES_IN": relationship_table_lives_in}),
    )
...
class TestRelationshipAttributesInduction:
    ...
    def test_base_case_no_attributes(self, test_context):
        ...
        assert len(result.column_names) == 6  # ID, SOURCE, TARGET, since, strength, verified
    ...
    def test_direction_preserved(self, test_context):
        ...
        assert result_left.source_algebraizable.direction == RelationshipDirection.LEFT
