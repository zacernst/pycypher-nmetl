...
@pytest.fixture()
def date_fn(registry: ScalarFunctionRegistry):  # noqa: ANN201
    """Return the raw _date callable from the registry."""
    return registry._functions["date"].callable  # noqa: SLF001


@pytest.fixture()
def datetime_fn(registry: ScalarFunctionRegistry):  # noqa: ANN201
    """Return the raw _datetime callable from the registry."""
    return registry._functions["datetime"].callable  # noqa: SLF001


@pytest.fixture()
def duration_fn(registry: ScalarFunctionRegistry):  # noqa: ANN201
    """Return the raw _duration callable from the registry."""
    return registry._functions["duration"].callable  # noqa: SLF001


@pytest.fixture()
def truncate_date_fn(registry: ScalarFunctionRegistry):  # noqa: ANN201
    """Return the raw _truncate_date callable."""
    return registry._functions["date.truncate"].callable  # noqa: SLF001


@pytest.fixture()
def truncate_datetime_fn(registry: ScalarFunctionRegistry):  # noqa: ANN201
    """Return the raw _truncate_datetime callable."""
    return registry._functions["datetime.truncate"].callable  # noqa: SLF001
...
class TestDateEmptySeries:
    ...
    def test_empty_series_returns_empty(self, date_fn) -> None:  # noqa: ANN001
...
class TestDateParsingFallback:
    ...
    def test_fallback_parses_valid_dates(self, date_fn) -> None:  # noqa: ANN001
    ...
    def test_fallback_handles_nulls(self, date_fn) -> None:  # noqa: ANN001
    ...
    def test_fallback_handles_unparseable(self, date_fn) -> None:  # noqa: ANN001
    ...
    def test_fallback_all_null(self, date_fn) -> None:  # noqa: ANN001
...
class TestDatetimeEmptySeries:
    ...
    def test_empty_series_returns_empty(self, datetime_fn) -> None:  # noqa: ANN001
        empty = pd.Series(dtype=object)
...
class TestDatetimeParsingFallback:
    ...
    def test_fallback_parses_valid_datetimes(self, datetime_fn) -> None:  # noqa: ANN001
        """Fallback uses datetime.fromisoformat row-by-row."""
        s = pd.Series(
            ["2024-01-15T10:30:00", "2024-06-01T09:00:00"], dtype=object
        )
        with patch("pandas.to_datetime", side_effect=TypeError("forced")):
    ...
    def test_fallback_handles_z_suffix(self, datetime_fn) -> None:  # noqa: ANN001
    ...
    def test_fallback_handles_nulls(self, datetime_fn) -> None:  # noqa: ANN001
        """Fallback path preserves None for null inputs."""
    ...
    def test_fallback_handles_unparseable(self, datetime_fn) -> None:  # noqa: ANN001
    ...
    def test_fallback_all_null(self, datetime_fn) -> None:  # noqa: ANN001
...
class TestDurationNullInput:
    ...
    def test_null_duration_returns_null(self, duration_fn) -> None:  # noqa: ANN001
        s = pd.Series([None], dtype=object)
        result = duration_fn(s)
        assert result.iloc[0] is None

    def test_null_among_valid(self, duration_fn) -> None:  # noqa: ANN001
...
class TestDurationInvalidString:
    ...
    def test_invalid_duration_becomes_none(self, duration_fn) -> None:  # noqa: ANN001
        s = pd.Series(["not-a-duration"], dtype=object)
        result = duration_fn(s)
        assert result.iloc[0] is None

    def test_various_invalid_strings(self, duration_fn) -> None:  # noqa: ANN001
...
class TestDurationParsingException:
    ...
    def test_mixed_valid_and_invalid(self, duration_fn) -> None:  # noqa: ANN001
    ...
    def test_map_form_duration(self, duration_fn) -> None:  # noqa: ANN001
...
class TestDateTruncateWeek:
    ...
    def test_week_truncation_monday(self, truncate_date_fn) -> None:  # noqa: ANN001
    ...
    def test_week_truncation_thursday(self, truncate_date_fn) -> None:  # noqa: ANN001
    ...
    def test_week_truncation_sunday(self, truncate_date_fn) -> None:  # noqa: ANN001
    ...
    def test_week_truncation_via_star(self, minimal_context: Context) -> None:
        ...
        result = star.execute_query(
            "MATCH (p:Person) "
            "RETURN date.truncate('week', date('2024-01-18')) AS d"
        )
...
class TestDatetimeTruncateInvalidUnit:
    ...
    def test_invalid_unit_nanosecond(self, truncate_datetime_fn) -> None:  # noqa: ANN001
    ...
    def test_invalid_unit_fortnight(self, truncate_datetime_fn) -> None:  # noqa: ANN001
...
class TestDatetimeTruncateWeek:
    ...
    def test_week_truncation_thursday(self, truncate_datetime_fn) -> None:  # noqa: ANN001
