...
PYCYPHER_MODULES = {
    ...
    "etl": ["data_source", "fact", "goldberg", "message_types", "queue_processor", "solver", "trigger"],
    "shims": ["networkx_cypher"],
    "util": ["cli", "config", "configuration", "exceptions", "helpers", "logger", "nmetl_cli"]
}

NMETL_MODULES = [
    "session", "data_source", "data_asset", "data_types", "queue_processor", 
    "configuration", "config", "logger", "nmetl_cli"
]

FASTOPENDATA_MODULES = [
    "ingest", "transform", "export", "utils"
]
...
"""
    ...
    for tutorial in ["getting_started", "advanced_usage"]:
        tutorial_path = BASE_DIR / package_name / "tutorials" / f"{tutorial}.rst"
