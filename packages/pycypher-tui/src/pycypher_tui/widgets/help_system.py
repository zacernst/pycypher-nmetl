...
_BUILTIN_TOPICS: dict[str, str] = {
    "index": (
        ...
        "=================\n\n"
        "Navigation\n"
        "  h/j/k/l    Move left/down/up/right (h also goes back)\n"
        "  gg         Jump to first item\n"
        "  G          Jump to last item\n"
        "  Enter      Select / drill into section\n"
        "  Ctrl-f/b   Move down / up 5 items\n\n"
        "Modes\n"
        "  i / o      Enter INSERT mode\n"
        "  a          Add item (on list screens) / INSERT after cursor\n"
        "  v          Enter VISUAL mode\n"
        "  :          Enter COMMAND mode\n"
    ...
    "navigation": (
        ...
        "  gg         Jump to first item\n"
        "  G          Jump to last item\n"
        "  Ctrl-f     Move down 5 items\n"
        "  Ctrl-b     Move up 5 items\n"
    ...
    "modes": (
        ...
        "  a          NORMAL → INSERT (after cursor); on list screens: add item\n"
