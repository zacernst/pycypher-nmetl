...
class Session:  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def __init__(
        ...
        # Read configuration
        with open(session_config_file) as config_file:
        ...
        with open(
            self.configuration.data_source_config_file
    ...
    def parquet_from_node_label(
        self, label: str, path: str | None = None
    ) -> None:
    ...
    def data_source_by_name(self, name: str) -> DataSource | None:
    ...
    def new_column(
        self,
        data_source_name: str,
        attach_to_data_source: bool | None = True,
