...
from nmetl.config import (
    DEFAULT_QUEUE_SIZE,  # pyrefly: ignore
    INNER_QUEUE_TIMEOUT,  # pyrefly: ignore
    OUTER_QUEUE_TIMEOUT,  # pyrefly: ignore
)
...
class QueueGenerator:  # pylint: disable=too-few-public-methods,too-many-instance-attributes
    ...
    def __init__(
        ...
        **kwargs,  # pylint: disable=unused-argument
        ...
        self.queue = queue_cls(1024)  # TODO: Add max queue sizes later
