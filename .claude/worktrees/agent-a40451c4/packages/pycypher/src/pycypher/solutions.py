...
class ProjectionTree(ABC):
    ...
    def __init__(self, parent: Projection | ProjectionList | None = None):
        ...
        self.parent: Projection | ProjectionList | None = parent
        if parent:
...
class Projection(ProjectionTree):
    ...
    def __init__(
        ...
        parent: Projection | ProjectionList | None = None,
    ):
