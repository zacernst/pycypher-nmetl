...
class ValidationIssue(BaseModel):
    ...
    def __init__(
        self,
        severity: Union[ValidationSeverity, dict] | None = None,
...
class PatternPath(Algebraizable):
    ...
    variable: Variable | None = None
    elements: list[Union[NodePattern, RelationshipPattern]] = Field(
...
class Exists(Expression):
    ...
    content: Union[Pattern, Query] | None = None
...
class ASTConverter:
    ...
    def _convert_ReturnItem(self, node: dict) -> ReturnItem:
        ...
        return ReturnItem(
            expression=cast(
                "Expression | None", self.convert(node.get("expression"))
            ),
    ...
    def _convert_SetProperty(self, node: dict) -> SetItem:
        ...
        return SetItem(
            ...
            property=prop,
            expression=cast(
                "Expression | None", self.convert(node.get("value"))
            ),
            labels=[],
        )
    ...
    def _normalize_procedure_name(self, value: Any) -> str | None:  # type: ignore[override]
    ...
    def _convert_PatternPath(self, node: dict) -> PatternPath:
        ...
        return PatternPath(
            variable=Variable(name=var_name) if var_name else None,
            elements=cast(
                "list[Union[NodePattern, RelationshipPattern]]",
    ...
    def _convert_RelationshipPattern(self, node: dict) -> RelationshipPattern:
        ...
        return RelationshipPattern(
            ...
            direction=direction,
            length=cast(
                "PathLength | None", self.convert(node.get("length"))
            ),
            where=cast("Expression | None", self.convert(node.get("where"))),
        )
    ...
    def _convert_Not(self, node: dict) -> Not:
        ...
        return Not(
            operand=cast(
                "Expression | None", self.convert(node.get("operand"))
            )
        )
    ...
    def _convert_PropertyAccess(self, node: dict) -> PropertyLookup:
        ...
        return PropertyLookup(
            expression=cast(
                "Expression | None", self.convert(node.get("object"))
            ),
            property=node.get("property"),
        )
    ...
    def _convert_ListComprehension(self, node: dict) -> ListComprehension:
        ...
        return ListComprehension(
            variable=Variable(name=var_name) if var_name else None,
            list_expr=cast(
                "Expression | None", self.convert(node.get("in"))
            ),  # 'in' from grammar
            where=cast("Expression | None", self.convert(node.get("where"))),
            map_expr=cast(
                "Expression | None", self.convert(node.get("projection"))
    ...
    def _convert_PatternComprehension(
        ...
        return PatternComprehension(
            ...
            pattern=cast("Pattern | None", self.convert(node.get("pattern"))),
            where=cast("Expression | None", self.convert(node.get("where"))),
            map_expr=cast("Expression | None", self.convert(node.get("map"))),
        )
    ...
    def _convert_CaseExpression(self, node: dict) -> CaseExpression:
        ...
        return CaseExpression(
            ...
            else_expr=cast(
                "Expression | None", self.convert(node.get("else"))
            ),
        )
    ...
    def _convert_SimpleWhen(self, node: dict) -> WhenClause:
        ...
        return WhenClause(
            ...
            result=cast(
                "Expression | None", self.convert(node.get("result"))
            ),
        )
    ...
    def _convert_SearchedWhen(self, node: dict) -> WhenClause:
        ...
        return WhenClause(
            condition=cast(
                "Expression | None", self.convert(node.get("condition"))
            ),
            result=cast(
                "Expression | None", self.convert(node.get("result"))
            ),
    ...
    def _convert_Reduce(self, node: dict) -> Reduce:
        ...
        return Reduce(
            ...
            initial=cast(
                "Expression | None", self.convert(node.get("initial"))
            ),
            variable=Variable(name=var_name) if var_name else None,
            list_expr=cast(
                "Expression | None", self.convert(node.get("list"))
            ),
            map_expr=cast("Expression | None", self.convert(node.get("map"))),
        )
...
def _validate_unreachable_conditions(
    ...
    for match in node.find_all(Match):
        if cast("Match", match).where:
            if isinstance(
                cast("Match", match).where, BooleanLiteral
