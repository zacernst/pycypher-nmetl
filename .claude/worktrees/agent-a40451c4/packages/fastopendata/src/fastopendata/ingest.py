...
SOURCE_DIR = "/app/packages/fastopendata/"

INGEST_CONFIG_PATH: LiteralString = "packages/fastopendata/ingest.yaml"
PUMS_DATA_DICTIONARY_PATH: LiteralString = (
    "packages/fastopendata/data_assets/acs_pums_2023_data_dictionary.json"
)
...
if __name__ == "__main__":
    ...
    session = Session(
        session_config_file="packages/fastopendata/sample_session_config.toml"
    )
